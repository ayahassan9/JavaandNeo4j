...
public class UpdateEmployee extends JFrame implements ActionListener{
    ...
    UpdateEmployee(String empId) {
        ...
        // Nouvelle section pour le statut social
        ...
        try {
            ...
            while(rs.next()) {
                ...
                lbldob.setText(rs.getString("date"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                Conn conn = new Conn();
                String query = "update employe set fname = '"+fname+"', salary = '"+salary+"', adresse = '"+address+"', telephone = '"+phone+"', email =  '"+email+"', education = '"+education+"', status = '"+status+"', designation = '"+designation+"' where id = '"+empId+"'";
